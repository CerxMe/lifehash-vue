var Module = (function () {
  ...
  return function (Module) {
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("lifehash.wasm", import.meta.url).toString();
    }
    ...
    var asmLibraryArg = { r: ___assert_fail, i: ___cxa_allocate_exception, q: ___cxa_begin_catch, p: ___cxa_end_catch, b: ___cxa_find_matching_catch_2, f: ___cxa_find_matching_catch_3, k: ___cxa_free_exception, j: ___cxa_throw, c: ___resumeException, t: _abort, s: _emscripten_resize_heap, a: _getTempRet0, n: invoke_ii, e: invoke_iii, h: invoke_iiii, m: invoke_iiiii, u: invoke_v, d: invoke_vii, w: invoke_viid, g: invoke_viii, o: invoke_viiii, l: invoke_viiiii, v: invoke_viiiiii };
    var asm = createWasm();
